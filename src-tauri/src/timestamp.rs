...
pub async fn get_current_time(unit: String, format: Option<String>) -> TimestampConversionResponse {
...
pub async fn convert_timestamp(request: TimestampConversionRequest) -> TimestampConversionResponse {
